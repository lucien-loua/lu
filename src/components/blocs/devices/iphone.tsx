...
export interface Iphone15ProProps extends React.ComponentProps<"svg"> {
  image?: ImageAsset;
...
function Iphone({
  ...
  const imageUrl = useImageUrl(image ?? null);
  return (
    <svg
      width={width}
      height={height}
...
export const IphoneBlock = (props: Iphone15ProProps) => {
  return (
    <div className='not-prose flex justify-center w-full'>
      <Iphone {...props} />
    </div>
  );
};